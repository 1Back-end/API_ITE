	...
	<nav class="navbar navbar-expand">
		<div class="container px-3 px-md-5">
			...
			<a class="navbar-brand d-flex" href="index.html">
				...
				<h6 class="smaller text-muted mb-0 ms-2 d-none d-sm-block">Digital<br>Agency</h6>
			</a>
			<!-- Logo END -->
			...
			<div class="nav flex-nowrap align-items-center">
				...
				<div class="nav-item ms-4">
					<a class="nav-link p-0 flex-row" data-bs-toggle="offcanvas" href="#offcanvasEnd" role="button" aria-controls="offcanvasEnd">
						<span class="font-heading fw-bold" data-bs-target="#offcanvasEnd">Menu</span>
						<i class="bi bi-text-right rtl-flip display-8 align-middle" data-bs-target="#offcanvasEnd"></i>
					</a>
				</div>
				<!-- Nav Button -->
				<div class="nav-item d-none d-md-block ms-4">
					<a class="btn btn-line btn-primary btn-sm mb-0" href="#">Get a Quote</a>
				</div>
			</div>
			<!-- Nav Right END -->
...
<section class="pt-5">
	<div class="container-fluid">
		<div class="row g-0 d-flex align-items-center ms-xl-5 ms-xxl-8">
			<!-- Hero section left image-->
			<div class="col-lg-5 col-xxl-7 position-relative align-self-stretch py-8" style="background:url(assets/images/bg/10.jpg) no-repeat center center; background-size:cover;">
				<!-- Happy Customers -->
				<div class="position-absolute bottom-0 start-0 py-4 px-5 m-5 bg-white text-center">
					<i class="far fa-heart display-8 fw-normal text-primary opacity-4"></i>
					<h4 class="mb-0 text-primary">2035+</h4>
					<p class="mb-0">Happy Customers</p>
				</div>
			</div>
			<!-- Hero section right content -->
			<div class="col-lg-7 col-xxl-5 ms-lg-n3 ms-xl-n5 ms-xxl-n8 my-lg-5">
				<div class="bg-primary p-5 py-md-7 px-md-6 position-relative z-index-9 overflow-hidden">
					<!-- Shape Decoration START -->
					<figure class="position-absolute start-0 top-0 rtl-flip opacity-2 z-index-n9">
					...
					<!-- Hero content -->
					<h1 class="text-white">We're Folio, a Digital Agency unlike any other</h1>
					<p class="lead text-white mb-5">Rooms oh fully taken by worse do. Points afraid but may end law lasted. Was out laughter raptures returned outweigh.</p>
					<a href="#" class="btn btn-white btn-lg btn-line">Explore more</a>
				</div>
			</div>
		</div> <!-- Row END -->
	</div>
...
<section>
	<div class="container">
		<div class="row">
			<div class="col-md-8">
				<h2>Hero Section Split banner</h2>
				<p class="lead">A hero section is a large or oversized web banner that is pinned to the header section of a web-page, usually towards the top of the page. Because of its prominent place in the site’s visual hierarchy, the hero header is often the first thing users see when arriving on a website. Therefore, we are including 10 hero banners of different styles so that your site have a strong focus and visual interest — thus resulting into more growth.</p>
			</div>
		</div>
	</div>
</section>
