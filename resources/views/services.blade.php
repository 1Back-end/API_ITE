        ...
        <div class="container position-relative">
            <div class="row g-0 d-flex justify-content-end">
                ...
                <div class="col-6 mt-5 d-none d-md-block">
                    {{-- <img class="rounded" src="{{ pages('SERVICES')->banner == null?asset('assets/images/about/03.jpg'):asset('pages/banners/'.pages('SERVICES')->banner) }}" alt=""> --}}
                </div>
                <!-- Right image decoration -->
                <div class="col-2 mt-5 mb-8 d-none d-md-block">
            ...
            <div class="row">
                <div class="col-lg-8 position-absolute start-0 top-0 text-start mt-5 mt-md-9">
                    <h1 class="display-4 text-dark">{!! __('translate.list_of_services') !!}</h1>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="mb-6">
                        ...
                        <h4 class="mt-4 mb-4"><a href="/service/{{ $service->id }}">{{ session('lang') == 'en'?$service->name->en:$service->name->fr }}</a></h4>
                        <p>{{session('lang') == 'en'?$service->short_description->en:$service->short_description->fr}}</p>
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-4 mb-5">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <h4 class="text-white mt-0">{!! __('translate.home_research') !!}</h4>
                    </div>
                    <div class="ps-6">
                ...
                <div class="col-sm-6 col-md-4 mb-5">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <h4 class="text-white mt-0">{!! __('translate.home_design') !!}</h4>
                    </div>
                    <div class="ps-6">
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <h4 class="text-white mt-0">{!! __('translate.home_testing') !!}</h4>
                    </div>
                    <div class="ps-6">
