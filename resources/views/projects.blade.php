        ...
        <div class="container position-relative">
            <div class="row g-0 d-flex justify-content-end">
                ...
                <div class="col-6 mt-5 d-none d-md-block">
                    {{-- <img class="rounded" src="{{ pages('PROJECTS')->banner == null?asset('assets/images/about/03.jpg'):asset('pages/banners/'.pages('PROJECTS')->banner) }}" alt=""> --}}
                </div>
            ...
            <div class="row">
                <div class="col-lg-8 position-absolute start-0 top-0 text-start mt-5 mt-md-9">
                    <h1 class="display-4 text-dark">{!! __('translate.list_of_projects') !!} </h1>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="mb-6">
                        ...
                        <h4 class="mt-4 mb-4"><a href="/project/{{ $project->id }}">{{ $project->title }}</a></h4>
                        <p>{{session('lang') == 'en'?$project->short_description->en:$project->short_description->fr}}</p>
