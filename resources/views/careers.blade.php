								...
								<div class="dropdown-item ps-4">
									<div class="d-flex mb-2">
										...
										<div>
											...
											<a class="dropdown-item px-0" href="https://folio.webestica.com/docs/index.html">Introduction</a>
											<a class="dropdown-item px-0" href="https://folio.webestica.com/docs/index.html">Directory structure</a>
	...
	<div class="container">
		<div class="row d-flex justify-content-lg-between">
			...
			<div class="col-lg-7 mb-5">
				<h1 class="display-5 text-dark-stroke text-primary-shadow">Careers & Culture</h1>
				<q>Our mission is simple: give marvelous minds a place to do outstanding performance. </q>
			</div>
		</div> <!-- Row END -->
	</div>
</section>
	...
	<div class="container">
		<div class="row d-flex justify-content-lg-between align-items-center">
			...
			<div class="col-lg-6 mt-5 mt-lg-0">
				...
				<p>Benefits are the rewards that go beyond the paycheck. We offer a selection of benefits that meet our employees’ needs and expectations at different life stages. Examples for benefits at Folio are retirement benefits, health care and accident insurance. This is a great opportunity to work with a leading organization in the construction industry!</p>
				<!-- Benefits list -->
				<div class="d-md-flex flex-md-row my-5">
					<ul class="list-group list-group-borderless list-group-icon-primary-bg me-md-6">
						<li class="list-group-item"><span>1</span> Friendly, talented colleagues</li>
						<li class="list-group-item"><span>2</span> 2pm Fridays</li>
						<li class="list-group-item"><span>3</span> Professional development funds</li>
						<li class="list-group-item"><span>4</span> Career Development</li>
						<li class="list-group-item"><span>2</span> Future Provision</li>
					</ul>
					<ul class="list-group list-group-borderless list-group-icon-primary-bg">
						<li class="list-group-item"><span>6</span> Flexible Working Hours </li>
						<li class="list-group-item"><span>7</span> Health & Fitness </li>
						<li class="list-group-item"><span>8</span> Employee Gifts </li>
						<li class="list-group-item"><span>9</span> Welcome Aboard </li>
					</ul>
				</div>
				<!-- Button -->
				<a href="#" class="btn btn-dark">Our daily life on Instagram <i class="fab fa-instagram ms-2"></i></a>
			</div>
		</div>
	</div>
</section>
...
<section class="pt-5">
	<div class="tiny-slider">
		<div class="tiny-slider-inner" data-edge="100" data-autoplay="false" data-arrow="false" data-dots="false" data-items-xl="4" data-items-lg="4" data-items-md="3" data-items-sm="2" data-items-xs="1">

			<!-- Card item START -->
			<div class="item">
				<div class="card overflow-hidden">
					<!-- Full screen button -->
					<a class="card-element-hover position-absolute end-0 top-0 bg-primary p-3" href="https://youtu.be/n_Cn8eFo7u8" data-glightbox data-gallery="gallery"><i class="bi bi-play-btn display-9 text-white"></i></a>
					<!-- Card Image -->
			...
			<div class="item">
				<div class="card overflow-hidden">
					<!-- Full screen button -->
					<a class="card-element-hover position-absolute end-0 top-0 bg-primary p-3" href="assets/images/about/02.jpg" data-glightbox data-gallery="gallery"><i class="bi bi-fullscreen display-9 text-white"></i></a>
					<!-- Card Image -->
			...
			<div class="item">
				<div class="card overflow-hidden">
					<!-- Full screen button -->
					<a class="card-element-hover position-absolute end-0 top-0 bg-primary p-3" href="assets/images/about/03.jpg" data-glightbox data-gallery="gallery"><i class="bi bi-fullscreen display-9 text-white"></i></a>
					<!-- Card Image -->
			...
			<div class="item">
				<div class="card overflow-hidden">
					<!-- Full screen button -->
					<a class="card-element-hover position-absolute end-0 top-0 bg-primary p-3" href="assets/images/about/04.jpg" data-glightbox data-gallery="gallery"><i class="bi bi-fullscreen display-9 text-white"></i></a>
					<!-- Card Image -->
					<img class="rounded" src="assets/images/about/04.jpg" alt="">
				</div>
			</div>
			<!-- Card item END -->
			...
			<div class="item">
				<div class="card overflow-hidden">
					<!-- Full screen button -->
					<a class="card-element-hover position-absolute end-0 top-0 bg-primary p-3" href="assets/images/about/05.jpg" data-glightbox data-gallery="gallery"><i class="bi bi-fullscreen display-9 text-white"></i></a>
					<!-- Card Image -->
					<img class="rounded" src="assets/images/about/05.jpg" alt="">
				</div>
			</div>
			<!-- Card item END -->
			...
			<div class="item">
				<div class="card overflow-hidden">
					<!-- Full screen button -->
					<a class="card-element-hover position-absolute end-0 top-0 bg-primary p-3" href="assets/images/about/06.jpg" data-glightbox data-gallery="gallery"><i class="bi bi-fullscreen display-9 text-white"></i></a>
					<!-- Card Image -->
					<img class="rounded" src="assets/images/about/06.jpg" alt="">
				</div>
			</div>
			<!-- Card item END -->
		...
		<div class="row">
			<div class="col-md-7">
				...
				<div class="mb-5">
					...
					<p>Like what you saw? If you're ready to test your earning potential, join us today and become the latest member of creative team.</p>
				</div>
				<!-- Job positions START -->
				<div class="accordion accordion-icon" id="accordionjobpositions2">

				  <div class="accordion-item">
				    <h5 class="accordion-header d-flex justify-content-between align-items-center" id="heading-1">
				      <button class="accordion-button fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-1" aria-expanded="true" aria-controls="collapse-1">
				        Sr. Account Manager - Technologies
				      </button>
				      <span class="d-flex align-items-center text-body pe-2 small"><i class="fas fa-map-marker-alt me-2"></i>London</span>
				    </h5>
				    <div id="collapse-1" class="accordion-collapse collapse show" aria-labelledby="heading-1" data-bs-parent="#accordionjobpositions2">
				      <div class="accordion-body">
				        <p>We are excited about an opportunity we have within the Technologies team in London. We’re on the lookout for an Account Manager to join Folio top performing team for 2 years in a row! We want to hear from talented and ambitious sales professionals who have a passion for work.</p>
								<a href="careers-single.html" class="btn btn-dark btn-sm btn-line">Apply Now </a>
				      </div>
				    </div>
				  </div>
				  ...
				  <div class="accordion-item">
				    <h5 class="accordion-header d-flex justify-content-between align-items-center" id="heading-2">
				      ...
				      <span class="d-flex align-items-center text-body pe-2 small"><i class="fas fa-map-marker-alt me-2"></i>Sydney</span>
				    </h5>
				    <div id="collapse-2" class="accordion-collapse collapse" aria-labelledby="heading-2" data-bs-parent="#accordionjobpositions2">
				      <div class="accordion-body">
				        <p>Do you enjoy a sales environment with little administration? Enjoy using the latest recruitment technology without losing the ‘Human Touch’? Do you want to work for a company who believes in supporting your career and personal growth? Want to work for a division that has a boutique feel.</p>
								<a href="careers-single.html" class="btn btn-dark btn-sm btn-line">Apply Now </a>
				      </div>
				    </div>
				  </div>
				  ...
				  <div class="accordion-item">
				    <h5 class="accordion-header d-flex justify-content-between align-items-center" id="heading-3">
				      ...
				      <span class="d-flex align-items-center text-body pe-2 small"><i class="fas fa-map-marker-alt me-2"></i>Mumbai</span>
				    </h5>
				    <div id="collapse-3" class="accordion-collapse collapse" aria-labelledby="heading-2" data-bs-parent="#accordionjobpositions2">
				      <div class="accordion-body">
				        <p>This is a great opportunity to join a Folio start up in the IT industry. We provide a number of services to our clients in both England and Australia. Our services ensures our clients achieves energy efficiencies, accurate reporting whilst saving time.</p>
								<a href="careers-single.html" class="btn btn-dark btn-sm btn-line">Apply Now </a>
				      </div>
				    </div>
				  </div>
				  ...
				  <div class="accordion-item">
				    <h5 class="accordion-header d-flex justify-content-between align-items-center" id="heading-4">
				      ...
				      <span class="d-flex align-items-center text-body pe-2 small"><i class="fas fa-map-marker-alt me-2"></i>Dubai</span>
				    </h5>
				    <div id="collapse-4" class="accordion-collapse collapse" aria-labelledby="heading-2" data-bs-parent="#accordionjobpositions2">
				      <div class="accordion-body">
				        <p>We provide a number of services to our clients in both USA and Australia. Our services ensures our clients achieves energy efficiencies, accurate reporting whilst saving time. This is a great opportunity to join a Folio start up in the IT industry.</p>
								<a href="careers-single.html" class="btn btn-dark btn-sm btn-line">Apply Now </a>
				      </div>
				    </div>
				  </div>
				  ...
				  <div class="accordion-item">
				    <h5 class="accordion-header d-flex justify-content-between align-items-center" id="heading-5">
				      <button class="accordion-button fw-bold collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-5" aria-expanded="false" aria-controls="collapse-5">
				        Engineering Manager - Android Application Infrastructure
				      </button>
				      <span class="d-flex align-items-center text-body pe-2 small"><i class="fas fa-map-marker-alt me-2"></i>Liverpool</span>
				    </h5>
				    <div id="collapse-5" class="accordion-collapse collapse" aria-labelledby="heading-2" data-bs-parent="#accordionjobpositions2">
				      <div class="accordion-body">
				        <p>Join a Folio start up in the IT industry. We provide a number of services to our clients in both England and Australia. Our services ensures our clients achieves energy efficiencies, accurate reporting whilst saving time.</p>
								<a href="careers-single.html" class="btn btn-dark btn-sm btn-line">Apply Now </a>
				      </div>
				    </div>
				  </div>
			...
			<div class="col-md-5">
				<div class="bg-light rounded p-5">
					<h4>Who we are?</h4>
					<p>Hello, We are an insight and behavior-driven creative marketing agency. A Full package Digital Creative Agency Specializing in: Video Production, Web Design, Branding, Brand Strategy, Content Marketing and Aerial Cinematography.</p>
					<h5 class="mt-5">Apply via E-mail</h5>
					<p>If you need to send us mail regarding job opportunities, please write to us at <a href="mailto:contact@example.com">career@folio.com</a> for more information.</p>
					<h6 class="mt-5 text-muted">Apply now via WhatsApp, send us your Resume on <br/> <a class="mt-2 d-block" href="#">+(251) 854-6308</a></h6>
				</div>
			</div>
