...
<body class="has-navbar-vertical-aside navbar-vertical-aside-show-xl">
  ...
  <main id="content" role="main" class="main">
    ...
    <div class="container mt-4">
        <!-- page header -->
        <x-backend.page_header :user="'Admin'" title="Projects" :type="'Creer'"/>
        <!-- End page header -->
        <!-- Step Form -->
        <form class="js-step-form py-md-5" data-hs-step-form-options='{
                ...
                "isValidate": false
              }' enctype="multipart/form-data" method="POST" action="{{url('admin/projects/store')}}">
              @csrf
                ...
                <div id="addUserStepProfile" class="card card-lg active">
                  ...
                  <div class="card-body">
                     <!-- Profile Cover -->
                        <div class="profile-cover mb-4">
                            ...
                            <div class="profile-cover-content profile-cover-uploader p-3">
                                ...
                                <span class="d-none d-sm-inline-block ms-1">Télécharger Image Principale</span>
                                </label>
                            </div>
                    ...
                    <div class="row mb-4">
                      ...
                      <div class="col-sm-9">
                        <div class="input-group input-group-sm-vertical">
                          <input type="text" class="form-control" name="title"  aria-label="Clarice" required>
                        </div>
                      </div>
                    </div>
                    <!-- End Form -->
                    ...
                    <div class="row mb-4">
                      ...
                      <div class="col-sm-9">
                        <div class="input-group input-group-sm-vertical">
                          <input type="text" class="form-control"  name="url"  aria-label="Clarice" required>
                        </div>
                      </div>
                    </div>
                    <!-- End Form -->
                    ...
                    <div class="row mb-4">
                      ...
                      <div class="col-sm-9">
                        <!-- Select -->
                          <div class=" mb-4">
                            <input type="date" class="form-control" name="performed_on" id="formSwitch1">
                          </div>
                        <!-- End Select -->
                      </div>
                    </div>
