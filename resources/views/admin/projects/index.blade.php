...
<body class="has-navbar-vertical-aside navbar-vertical-aside-show-xl">
  ...
  <main id="content" role="main" class="main">
    ...
    <!-- Page Header -->
      <x-backend.index_page_header title="Projects" :user="'Admin'" :size="sizeof($projects)"/>
      <!-- End Page Header -->
              ...
              <td>
                <a class="d-flex align-items-center" href="#">
                  <div class="avatar avatar-circle">
                    <img class="avatar-img" src="{{$project->img!=null?asset('project-images/'.$project->img):""}}" onerror="src='{{asset('backend/img/160x160/img1.jpg')}}'" alt="Image Description">
                  </div>
                  <div class="ms-3">
                    <span class="d-block h5 text-inherit mb-0">{{$project->title}}
                    {{-- <i class="bi-patch-check-fill text-primary" data-toggle="tooltip" data-bs-placement="top" title="{{$project->short_desc}}"></i></span> --}}
                    {{-- <span class="d-block fs-5 text-body">{{$user->email}}</span> --}}
                  </div>
                </a>
              </td>
              <td>
                <a href="{{$project->url}}" target="_blank" id="js-daterangepicker-predefined" class="btn btn-white" type="button">
                  <i class="bi-link me-1"></i>
                  <span class="js-daterangepicker-predefined-preview">{{$project->url}}</span>
                </a>
              </td>
              <td>
                {{$project->performed_on}}
              </td>
              <td>
                <a role="button" class="btn btn-white btn-sm" href="{{url('admin/projects/edit/'.$project->id)}}">
                  <i class="bi-pencil-fill me-1"></i> Modifier
                </a>
                <a role="button" class="btn btn-danger btn-sm" href="#" onclick="if(confirm('Etes vous sur de vouloir suprimer le projet '+'{{$project->name}}')){ deleteProj('{{$project->id}}');}else{console.log('false');}">
  ...
  function deleteProj(id){
    window.location.href = "{{url('/')}}/admin/projects/delete?id="+id;
  }
  </script>
