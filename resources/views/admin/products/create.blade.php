  ...
  <main id="content" role="main" class="main">
    ...
    <div class="container mt-4">
        ...
        <form class="js-step-form py-md-5" data-hs-step-form-options='{
                ...
                "isValidate": false
              }' enctype="multipart/form-data" method="POST" action="{{url('admin/products/store')}}">
              @csrf
                ...
                <div id="addUserStepProfile" class="card card-lg active">
                  ...
                  <div class="card-body">
                    ...
                    <div class="row mb-4">
                      ...
                      <div class="col-sm-9">
                        <div class="input-group input-group-sm-vertical">
                          <input type="number" class="form-control"  name="price"  aria-label="Clarice" >
                        </div>
                      </div>
                    </div>
                    <!-- End Form -->
                    ...
                    <!-- Form -->
                    <div class="row mb-4">
                      <label for="firstNameLabel" class="col-sm-3 col-form-label form-label">Courte Description (FR)</label>
                    ...
                    <!-- Form -->
                    <div class="row mb-4">
                      <label for="firstNameLabel" class="col-sm-3 col-form-label form-label">Courte Description (EN)</label>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group input-group-sm-vertical">
                            <input type="text" class="form-control"  name="url"  aria-label="Clarice">
                            </div>
                        </div>
                    </div>
                    <!-- End Form -->
