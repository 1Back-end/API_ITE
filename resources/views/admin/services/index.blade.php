...
<body class="has-navbar-vertical-aside navbar-vertical-aside-show-xl">
  ...
  <main id="content" role="main" class="main">
    ...
    <!-- Page Header -->
      <x-backend.index_page_header title="Services" :user="'Admin'" :size="sizeof($services)"/>
      <!-- End Page Header -->
        ...
        <div class="table-responsive datatable-custom">
          <table id="exportDatatable" class="js-datatable table table-borderless table-thead-bordered table-nowrap table-align-middle card-table"
            ...
            <tr>
              <td>
                <a class="d-flex align-items-center" href="#">
                  <div class="avatar avatar-circle">
                    <img class="avatar-img" src="{{asset('company-services/'.$service->img)}}" onerror="src='{{asset('backend/img/160x160/img1.jpg')}}'" alt="Image Description">
                  </div>
                  <div class="ms-3">
                    <span class="d-block h5 text-inherit mb-0">{{$service->name->fr}}
                    {{-- <i class="bi-patch-check-fill text-primary" data-toggle="tooltip" data-bs-placement="top" title="{{$service->short_desc}}"></i></span> --}}
                    <span class="d-block fs-5 text-body">{{$service->name->en}}</span>
                  </div>
                </a>
              </td>
              {{-- <td>
                  <span class="js-daterangepicker-predefined-preview">{{$service->type}}</span>
              </td> --}}
              {{-- <td>
                {{$service->price}}
              </td>
              ...
              <td>
                <a role="button" class="btn btn-white btn-sm mr-3" href="{{url('admin/services/edit/'.$service->id)}}">
                  <i class="bi-pencil-fill me-1"></i> Modifier
                </a>
                <a role="button" class="btn btn-danger btn-sm" href="#" onclick="if(confirm('Etes vous sur de vouloir suprimer le service '+'{{$service->img_tag}}')){deleteProd('{{$service->id}}');}else{console.log('false');}">
  ...
  function deleteProd(id){
    window.location.href = "{{url('/')}}/admin/services/delete?id="+id;
  }
  </script>
