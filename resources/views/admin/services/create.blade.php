...
<body class="has-navbar-vertical-aside navbar-vertical-aside-show-xl">
  ...
  <main id="content" role="main" class="main">
    ...
    <div class="container mt-4">
        <!-- page header -->
        <x-backend.page_header :user="'Admin'" title="Services" :type="'Creer'"/>
        <!-- End page header -->
        <!-- Step Form -->
        <form class="js-step-form py-md-5" data-hs-step-form-options='{
                ...
                "isValidate": false
              }' enctype="multipart/form-data" method="POST" action="{{url('admin/services/store')}}">
              @csrf
                ...
                <div id="addUserStepProfile" class="card card-lg active">
                  ...
                  <div class="card-body">
                    ...
                    <div class="row mb-4">
                      ...
                      <div class="col-sm-9">
                        <div class="input-group input-group-sm-vertical">
                          <input type="text" class="form-control" name="name_fr"  aria-label="Clarice" required>
                        </div>
                      </div>
                    </div>
                    <!-- End Form -->
                    ...
                    <div class="row mb-4">
                      ...
                      <div class="col-sm-9">
                        <div class="input-group input-group-sm-vertical">
                          <input type="text" class="form-control" name="name_en"  aria-label="Clarice" required>
                        </div>
                      </div>
                    </div>
                    <!-- End Form -->
                    ...
                    {{-- <div class="row mb-4">
                      ...
                      <div class="col-sm-9">
                        <div class="input-group input-group-sm-vertical">
                          <input type="number" class="form-control"  name="quantity"  aria-label="Clarice" required>
                        </div>
                      </div>
                    </div>
                    <!-- End Form -->
                    ...
                    <div class="row mb-4">
                      ...
                      <div class="col-sm-9">
                        <div class="input-group input-group-sm-vertical">
                          <input type="number" class="form-control"  name="price"  aria-label="Clarice" required>
                        </div>
                      </div>
                    </div>
                    <!-- End Form --> --}}
                    ...
                    <div class="row mb-4">
                      ...
                      <div class="col-sm-9">
                        <div class="input-group input-group-sm-vertical">
                          <input type="text" class="form-control"  name="short_description_fr"  aria-label="Clarice" required>
                        </div>
                      </div>
                    </div>
                    <!-- End Form -->
                    ...
                    <div class="row mb-4">
                      ...
                      <div class="col-sm-9">
                        <div class="input-group input-group-sm-vertical">
                          <input type="text" class="form-control"  name="short_description_en"  aria-label="Clarice" required>
                        </div>
                      </div>
                    </div>
                    <!-- End Form -->
                    ...
                    <!-- Form -->
                    <div class="row mb-4">
                      <label for="firstNameLabel" class="col-sm-3 col-form-label form-label">Longue Description (FR)<code>*</code></label>
                    ...
                    <!-- Form -->
                    <div class="row mb-4">
                      <label for="firstNameLabel" class="col-sm-3 col-form-label form-label">Longue Description (EN)<code>*</code></label>
                  ...
                  <!-- Footer -->
                  <input type="hidden" name="description_fr" id="long-desc-hidden" >
                  <input type="hidden" name="description_en" id="long-desc-hidden-2" >
