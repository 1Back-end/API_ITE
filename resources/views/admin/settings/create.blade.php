  ...
  <main id="content" role="main" class="main">
    ...
    <div class="content container">
      <!-- Page Header -->
        ...
        <x-backend.page_header :user="'Admin'" title="Settings" type="Create"/>
        <!-- End Page Header -->
         ...
         @csrf
          ...
          <div>
            ...
            <div class="row mb-3 mt-5">
              ...
              <div class="col-sm-9 d-flex">
                ...
                <label class="avatar avatar-xxl avatar-circle avatar-uploader" for="editAvatarUploaderModal">
                  <img id="editAvatarImgModal" class="avatar-img" src='{{asset('backend/img/160x160/img1.jpg')}}'alt="Image Description">
            ...
            <div class="mb-3">
              ...
              <div class="">
                <input type="text" name="company_slogan" class="form-control" required>
              </div>
            </div>
            <!-- End Input Group -->
            ...
            <!-- Input Group -->
            <div class="mb-3">
              <label for="inputGroupMergeFullName" class="form-label">Date de creation de l'entreprise </label>

              <div class="">
                <input type="text" name="company_creation_date" class="form-control">
              </div>
            </div>
            <!-- End Input Group -->
              ...
              <div class="row">
                <div class="col-md-4">
                    <div class=" input-group ">
                        ...
                        <input type="number" class="form-control" name="projects">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class=" input-group ">
