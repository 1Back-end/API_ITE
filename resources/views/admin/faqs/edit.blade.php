...
<body class="has-navbar-vertical-aside navbar-vertical-aside-show-xl">
  ...
  <main id="content" role="main" class="main">
    ...
    <div class="container mt-4">
        <!-- page header -->
        <x-backend.page_header :user="'Admin'" title="Faqs" :type="'Edit'"/>
        <!-- End page header -->
        <!-- Step Form -->
        <form class="js-step-form py-md-5" data-hs-step-form-options='{
                ...
                "isValidate": false
              }' enctype="multipart/form-data" method="POST" action="{{url('admin/faqs/update')}}">
              @csrf
                ...
                <div id="addUserStepProfile" class="card card-lg active">
                  ...
                  <div class="card-body">
                    ...
                    <div class="row mb-4">
                      ...
                      <div class="col-sm-9">
                        <div class="input-group input-group-sm-vertical">
                          <input type="text" class="form-control" name="question_fr" value="{{$faq->question->fr}}" placeholder="Clarice" aria-label="Clarice" required>
                    ...
                    <div class="row mb-4">
                      ...
                      <div class="col-sm-9">
                        <div class="input-group input-group-sm-vertical">
                          <input type="text" class="form-control" name="question_en" value="{{$faq->question->en}}" placeholder="Clarice" aria-label="Clarice" required>
                          {{-- <input type="text" class="form-control" name="lastName" id="lastNameLabel" placeholder="Boone" aria-label="Boone"> --}}
                        </div>
                      </div>
                    </div>
