        ...
        <div class="container position-relative">
            <div class="row g-0 d-flex justify-content-end">
                ...
                <div class="col-6 mt-5 d-none d-md-block">
                    {{-- <img class="rounded" src="{{ pages('PRODUCTS')->banner == null?asset('assets/images/about/03.jpg'):asset('pages/banners/'.pages('PRODUCTS')->banner) }}" alt=""> --}}
                </div>
            ...
            <div class="row">
                <div class="col-lg-8 position-absolute start-0 top-0 text-start mt-5 mt-md-9">
                    <h1 class="display-4 text-dark">{{ __('translate.our') }} <span class="text-dark-stroke text-primary-shadow">{{ __('translate.product') }}s</span></h1>
                    <a href="#" class="btn btn-dark btn-line">{{ __('translate.talk2expert') }}</a>
                </div>
            </div><!-- Row END -->
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="mb-6">
                        <span class="text-primary display-6"><i class="fas fa-check"></i></span>
                        <h4 class="mt-4 mb-4"><a href="/product/{{ $product->id }}">{{ session('lang') == 'en'?$product->name->en:$product->name->fr }}</a></h4>
                        <p>{{session('lang') == 'en'?$product->short_description->en:$product->short_description->fr}}</p>
                        <div class="list-group list-group-borderless list-unstyled">
                            @foreach($product->categories as $category)
                            <a href="#" class="list-group-item bg-transparent">{{ session('lang') == 'en'?$category->name->en:$category->name->fr }}</a>
                            @endforeach
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-4 mb-5">
                    <div class="text-start position-relative">
                        ...
                        <h4 class="text-white position-absolute start-0 top-0 mt-0 mt-sm-3 ps-6 d-block">{!! __('translate.home_research') !!}</h4>
                    </div>
                    <div class="ps-6">
                ...
                <div class="col-sm-6 col-md-4 mb-5">
                    <div class="text-start position-relative">
                        ...
                        <h4 class="text-white position-absolute start-0 top-0 mt-0 mt-sm-3 ps-6 d-block">{!! __('translate.home_design') !!}</h4>
                    </div>
                    <div class="ps-6">
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="text-start position-relative">
                        ...
                        <h4 class="text-white position-absolute start-0 top-0 mt-0 mt-sm-3 ps-6 d-block">{!! __('translate.home_testing') !!}</h4>
                    </div>
                    <div class="ps-6">
        ...
        <div class="container">
            <div class="row justify-content-lg-between">
                ...
                <div class="col-md-4 col-xl-5">
                    <h4>{{ __('translate.contact_desc') }}</h4>
                    <a class="display-6 font-heading mb-3 text-dark-stroke text-primary-shadow" href="#"> {{ __('translate.contact_us') }}</a>
                </div>
                <div class="col-md-8 col-xl-6 mt-5 mt-md-0">
                    <p class="lead">{{ session('lang') == 'en'?pages('ABOUT')->short_description->en:pages('ABOUT')->short_description->fr }}</p>
                </div>
            </div> <!-- Row END -->
        </div>
    </section>
